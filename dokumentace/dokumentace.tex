...
We divided the work on the project taking into account its complexity and labor intensity. Thus, everyone received a percentage rating in the amount indicated in the table \ref{table:distribution_of_work}. 
	...
	\begin{table}[ht]
		...
		\begin{tabular}{| l | l |}
			...
			\textbf{Ondřej Keprt, xkeprt03: 40\%} & \begin{tabular}{l} team management, organization of work, control over the execution of work,\\ consultation, project structure, target code generation, testing, documentation,\\
			syntactic analysis, semantic analysis \end{tabular} \\
			Oleg Trofimov, xtrofi00: 30\% & \begin{tabular}{l} lexical analysis, testing, documentation \end{tabular} \\
			Maxim Gerasimov, xgeras00: 30\% & \begin{tabular}{l} syntactic analysis of the shipment, testing, documentation \end{tabular} \\
