...
\begin{enumerate}
    ...
    \item \texttt{<prog>\arrow{} <call\_fce> <prog>}
    ...
    \item \texttt{<init2>\arrow{}<call\_fce>}
    \item \texttt{<init2>\arrow{}<expression>}
    \item \texttt{<statement>\arrow<identif\_list> \term{=} <assigment>}
    \item \texttt{<identif\_list>\arrow{}\term{identif}<identif\_list2>}
    \item \texttt{<identif\_list2>\arrow{}\term{,}<identif><identif\_list2>}
    \item \texttt{<identif\_list2>\arrow{}$\epsilon$}
    ...
    \item \texttt{<statement>\arrow{}\term{return}<expression\_list>}
    \item \texttt{<statement>\arrow{}<call\_fce>}
    \item \texttt{<call\_fce>\arrow{}\term{identif} \term{$($} <value\_list> \term{$)$}}
    ...
    \item \texttt{<assigment>\arrow{}<expression\_list>}
    \item \texttt{<assigment>\arrow{}<call\_fce>}
\end{enumerate}
